    ...
    for a in area:
        ...
        for car in vehicles:
            if car.is_available == True:
                vehicle_dictionary = {'name':car.car_name, 'vehichle_number':car.vehichle_number, 'id':car.id, 'pincode':car.area.pincode, 'capacity':car.capacity, 'rent':car.rent}
...
def confirm(request):
    ...
    if vehicle.is_available:
        ...
        rent = (int(vehicle.rent))*(int(days))
